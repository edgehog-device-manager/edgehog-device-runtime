        ...
        C: Client + Send + Sync + 'static,
    {
        ...
        match interface {
            ...
            TelemetryInterface::WiFiScanResults => {
                let telemetry = WifiScan::default();
        ...
        C: Client + Send + Sync + 'static,
    {
        cfg_if::cfg_if! {
            if #[cfg(feature = "containers")] {
                ...
                tracing::warn!("the {container_interface} telemetry interface is not supported because the zbus feature is missing")
            }
        }
    }
