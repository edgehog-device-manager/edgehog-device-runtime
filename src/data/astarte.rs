...
impl From<DeviceManagerOptions> for AstarteSDKOptions {
    fn from(opts: DeviceManagerOptions) -> Self {
        AstarteSDKOptions {
            realm: opts.realm,
            device_id: opts.device_id,
            credentials_secret: opts.credentials_secret,
            pairing_url: opts.pairing_url,
            pairing_token: opts.pairing_token,
            interfaces_directory: opts.interfaces_directory,
            astarte_ignore_ssl: opts.astarte_ignore_ssl,
        }
    }
}
...
impl Astarte {
    pub async fn new(
        opts: AstarteSDKOptions,
        store_directory: String,
    ) -> Result<Astarte, DeviceManagerError> {
