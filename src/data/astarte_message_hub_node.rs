...
use astarte_message_hub_proto::tonic::transport::Endpoint;
...
pub enum MessageHubError {
    ...
    /// Invalid endpoint
    Endpoint(#[from] astarte_message_hub_proto::tonic::transport::Error),
}
...
impl AstarteMessageHubOptions {
        ...
        P: AsRef<Path>,
    {
        ...
        let grpc_cfg = GrpcConfig::new(DEVICE_RUNTIME_NODE_UUID, endpoint);
