...
use astarte_device_sdk::{event::FromEventError, from_event, AstarteDeviceDataEvent, FromEvent};
...
impl FromEvent for CreateRequests {
    ...
    fn from_event(value: AstarteDeviceDataEvent) -> Result<Self, Self::Err> {
