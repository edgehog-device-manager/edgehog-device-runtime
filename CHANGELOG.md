...
## [0.13.0](https://github.com/edgehog-device-manager/edgehog-device-runtime/compare/edgehog-device-runtime-store-v0.12.2...edgehog-device-runtime-store-v0.13.0) - 2026-09-25
### `edgehog-device-runtime-store` - [0.13.0](https://github.com/edgehog-device-manager/edgehog-device-runtime/compare/edgehog-device-runtime-store-v0.12.2...edgehog-device-runtime-store-v0.13.0) - 2026-09-25

#### Added

- _(container)_ add additional fields

#### Changed

- _(proto)_ move the service proto to the repo


## [0.12.2](https://github.com/edgehog-device-manager/edgehog-device-runtime/compare/v0.12.1...v0.12.2) - 2026-08-25
...
- _(fileTransfer)_ add the file transfer interface
...
- (telemetry) read base image from ENV

## [0.10.5] - 2026-04-07

### Fixed

- (containers): change port bindings primary key
