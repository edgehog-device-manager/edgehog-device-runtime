...
## [0.12.3](https://github.com/edgehog-device-manager/edgehog-device-runtime/compare/edgehog-device-forwarder-proto-v0.1.0...edgehog-device-forwarder-proto-v0.12.3) - 2026-08-31
### `edgehog-device-forwarder-proto` - [0.12.3](https://github.com/edgehog-device-manager/edgehog-device-runtime/compare/edgehog-device-forwarder-proto-v0.1.0...edgehog-device-forwarder-proto-v0.12.3) - 2026-08-31

#### Added

- _(forwarder)_ add HTTPS as a supported protocol
