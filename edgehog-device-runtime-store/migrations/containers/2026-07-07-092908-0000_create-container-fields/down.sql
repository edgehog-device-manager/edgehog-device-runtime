...
WHERE count IS null;
ALTER TABLE device_requests ADD COLUMN count_v2 BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE containers ADD COLUMN privileged_v2 BOOLEAN NOT NULL DEFAULT false;
...
ALTER TABLE containers ADD COLUMN read_only_rootfs_v2 BOOLEAN NOT NULL DEFAULT false;
...
UPDATE containers SET restart_policy = 0
WHERE restart_policy IS null;
ALTER TABLE containers ADD COLUMN restart_policy_v2 INTEGER NOT NULL 0;
...
ALTER TABLE containers ADD COLUMN network_mode_v2 TEXT NOT NULL DEFAULT "bridge";
