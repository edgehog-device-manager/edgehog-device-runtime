...
ALTER TABLE container_tmpfs ADD COLUMN options_v2 TEXT NOT NULL DEFAULT "";
UPDATE container_tmpfs SET options_v2 = COALESCE(options, "");
ALTER TABLE container_tmpfs DROP COLUMN options;
ALTER TABLE container_tmpfs RENAME COLUMN options_v2 TO options;

ALTER TABLE container_storage_options ADD COLUMN value_v2 TEXT NOT NULL DEFAULT "";
UPDATE container_storage_options SET value_v2 = COALESCE(value, "");
