        ...
        D: Client + Sync + 'static,
    {
        match &self {
            NodeType::Image(image) => {
                store.append(id.clone(), image.into(), deps).await?;
            ...
            NodeType::Volume(volume) => {
                store.append(id.clone(), volume.into(), deps).await?;
            ...
            NodeType::Network(network) => {
                store.append(id.clone(), network.into(), deps).await?;
            ...
            NodeType::Container(container) => {
                store.append(id.clone(), container.into(), deps).await?;
            ...
            NodeType::Deployment => {
                store.append(id.clone(), Resource::Deployment, deps).await?;
